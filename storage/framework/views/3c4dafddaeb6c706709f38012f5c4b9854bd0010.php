...
<body>
	<div class="flex-container">
		<div class="flex-item">
	 	...
	 	<h4><?php echo $__env->yieldContent('subtitulo'); ?></h4>
  		<table class="col" id="row">

  	 		<?php echo $__env->yieldContent('conteudo'); ?><br>
  		</table>
...
<?php /**PATH C:\Escola-Ceraima\resources\views/layouts/login.blade.php ENDPATH**/ ?>